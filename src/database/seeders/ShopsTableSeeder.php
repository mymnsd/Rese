...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $areaData = DB::table('areas')->pluck('id', 'name');
        $genreData = DB::table('genres')->pluck('id', 'name');
        ...
        $managerEmail = 'storemanager@example.com';
        $manager = StoreManager::where('email', $managerEmail)->first();
    if (!$manager) {
        ...
        $param = [
            ...
            'area_id' => $areaData['東京都'],
            'genre_id' => $genreData['寿司'],
        ...
        $param = [
            ...
            'area_id' => $areaData['大阪府'],
            'genre_id' => $genreData['焼肉'],
        ...
        $param = [
            ...
            'area_id' => $areaData['福岡県'],
            'genre_id' => $genreData['居酒屋'],
