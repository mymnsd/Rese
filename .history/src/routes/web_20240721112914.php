...
// QRコード
Route::get('/reservations/{reservation}/qrcode', [QRCodeController::class, 'generate'])->name('qrcode.qrcode');
Route::get('/reservations/{reservation}/verify', [ReservationController::class, 'verify'])->name('qrcode.verify');
